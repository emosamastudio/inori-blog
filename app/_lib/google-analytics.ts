...
<script>
  ...
  document.addEventListener('click', function (event) {
    ...
    if (lowerHref.includes('github.com/emosamastudio/inori-blog/releases')) cta = 'download_desktop';
    else if (lowerHref === 'https://github.com/emosamastudio/inori-blog' || lowerLabel.includes('star')) cta = 'star_github';
    else if (lowerHref.includes('discord.gg/')) cta = 'join_discord';
    else if (lowerHref.includes('github.com/emosamastudio/inori-blog/issues')) cta = 'open_issue';
