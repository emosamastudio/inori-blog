...
const en: HomeCopy = {
  ...
  heroJoinDiscord: 'Say Hello',
  heroCtaStar: 'Visit GitHub',
  ...
  testimonialQuotePre: '“Inori helped me turn vague',
  ...
  ctaLead:
    'Visit GitHub, drop a comment, or just say hello. Inori is always listening.',
  ctaPrimary: 'Visit GitHub',
