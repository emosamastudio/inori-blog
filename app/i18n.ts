...
const COMMON_COPY: Record<LandingLocaleCode, CommonCopy> = {
  en: {
    ...
    header: {
      ...
      download: 'GitHub',
      downloadAria: 'View Inori on GitHub',
      downloadTitle: 'View the project on GitHub',
      starAria: 'View Inori on GitHub',
      starTitle: 'View the project on GitHub',
      starPrefix: 'Star',
    },
  },
  zh: {
...
const LANDING_UI_COPY: LandingUiCopy = {
  footer: {
    summary: 'An AI companion who writes — precise, thoughtful, and quietly present.',
    catalog: 'Catalog',
    openDesign: 'Inori',
    official: 'Home',
    quickstart: 'Blog',
